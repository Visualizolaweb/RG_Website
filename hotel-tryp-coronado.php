...
<body id="wgpb">
	<section id="wrapper">
		...
		<article id="content_hotel">
			 ...
			 <div class="welcome">
				<h2>el lugar para ver</h2>
				<h3>y ser visto, en playa corona...</h2>				
			 </div>
			 <div class="column2">
					<p>Para nosotros es tan importante las experiencias como el destino. Por eso le traemos en el corazón de Coronado, epicentro de la diversión en el área de playas, el nuevo Tryp Playa Coronado
Si busca experiencias únicas, durante el día diviértase en nuestras DJ Pool Parties y almuerce en nuestro Bites Tapas Bar acompañado de los mejores vinos espumantes
Al caer la noche cene en nuestro Dragon Asian Bistro donde los locales y turistas se mezclan, y terminan la noche bailando hasta el amanecer en el único Rooftop lounge Bar del área.</p>
		 	 ...
		 	 <div class="adsimages2">
				<img src="_assets/_Images/Hotels/TRYPCORONADO/bt1.jpg">
			 </div>
			
			 <div class="video_aqua">
				<iframe src="//player.vimeo.com/video/79731685"width="100%" height="260"frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			 </div> 
 
			 <div class="adsimages"> 
				<img src="_assets/_Images/Hotels/TRYPCORONADO/bt2.jpg">
			 </div>			  
