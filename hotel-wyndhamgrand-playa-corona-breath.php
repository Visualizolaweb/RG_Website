		...
		<article id="content_hotel">
			 ...
			 <div id="rooms" class="rooms">
				...
				<h3>NUESTRAS HABITACIONES</h3>
			 	...
			 	<img src="_assets/_Images/Hotels/WGPlaya_blanca/rooms/cover1.jpg" width="100%">
				<p class="both">	</br>Déjese impresionar de nuestras 211 habitaciones con diseños de interiores frescos y de lujo, donde todos los detalles fueron escogidos a mano para brindarle espacios abiertos únicos con vista al mar. </p>
				<p>Todas nuestras habitaciones están equipadas con:</p>
