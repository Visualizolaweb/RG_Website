		...
		<article id="content_hotel">
			 ...
			 <div id="rooms" class="rooms">
				...
				<h3>NUESTRAS HABITACIONES</h3>
			 	<img src="_assets/_Images/Hotels/WGPlaya_blanca/rooms/cover4.jpg" width="100%">
				<p class="both">	</br>vive una experiencia de lujo en nuestro Penthouse de 2 Recámaras con una Cama King y en el segundo dormitorio una cama full. Nuestro All in se termina de complementar en estas habitaciones con:</p>

					<ul class="listroom">
						<li>Zen Bathrooms con bañera y ducha </li>
